                                        ...
                                        <div class="multisteps-form__panel js-active" data-animation="scaleIn">
                                            ...
                                            <div class="multisteps-form__content">
                                                ...
                                                <div class="button-row d-flex justify-content-end mt-4">
                                                    ...
                                                    <button class="js-btn-simpan btn btn-primary ml-auto  mybtn"
                        ...
                        <div id="additionalFormContainer" style="display: none;">
                            <form class="addForm" action="{{ route('detailPeminjaman.AddBarcode') }}" method="post">
                                ...
                                <div class="form-row mt-3">
                                    ...
                                    {{-- <div class="form-group mt-2">
                                        <label for="ket_barang">Nama Barang</label>
                                        <input type="text" name="ket_barang" id="ket_barang" class="form-control" value="{{''}}">
...
$(document).ready(function() {
    ...
    $("#formPeminjaman").on('click', '.js-btn-simpan', function(e) {
        ...
        if (idPeminjaman) {
            url = '/peminjaman/update/' + idPeminjaman;
            method = 'PUT';
        }
